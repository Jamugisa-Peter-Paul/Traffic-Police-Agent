...
class SafetyJacketDetector:
    def __init__(self, model_path="models/best_jacket.pt", conf_threshold=0.5, 
        ...
        Args:
            ...
            imgsz (int): Input image size for inference (smaller = faster on CPU).
        """
        ...
        try:
            ...
            self.loaded = True
            print(f"Safety Jacket Detector loaded: {model_path} (device={device}, imgsz={imgsz})")
    ...
    def detect(self, frame):
        ...
        # Run inference with configured device and image size
